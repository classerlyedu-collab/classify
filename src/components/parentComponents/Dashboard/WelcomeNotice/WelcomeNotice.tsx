...
import { WelcomeImagesArray } from "../../../../constants/parent/dashdoard";
...
const WelcomeNotice = () => {
    ...
    return (
        <div className="w-full bg-lightbrown h-full py-5 px-4 rounded-2xl flex flex-row justify-center items-center">
            <div>
                <div>
                    ...
                    <div className="py-3 flex flex-col">
                        ...
                        <p className="text-sm md:text-base font-ubuntu text-greyBlack">Please stay connected and updated on the parent portal
                        </p>
                    </div>
            ...
            <div className="justify-center items-center hidden sm:flex">
                <img className="w-80 md:w-62" src={WelcomeImagesArray[currentImageIndex]} alt="Welcome" />
            </div>
        </div>
    )
}
