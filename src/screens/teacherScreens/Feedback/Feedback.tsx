                ...
                <div className="p-4 sm:p-6 border-b border-gray-200">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="hidden sm:block bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full font-semibold text-xs sm:text-sm">
                        {feedbacks.length} Reviews
                      </div>
                      <div className="inline-flex bg-gray-100 rounded-lg p-1 w-full sm:w-auto">
                        <button
                          onClick={() => setActiveRightTab("list")}
                          className={`flex-1 sm:flex-none px-2 sm:px-3 py-1.5 text-xs sm:text-sm font-medium rounded-md ${activeRightTab === 'list' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-600 hover:text-gray-800'}`}
                        >
                          Reviews
                        </button>
                        <button
                          onClick={() => setActiveRightTab("give")}
                          className={`flex-1 sm:flex-none px-2 sm:px-3 py-1.5 text-xs sm:text-sm font-medium rounded-md ${activeRightTab === 'give' ? 'bg-white shadow-sm text-gray-900' : 'text-gray-600 hover:text-gray-800'}`}
                        >
                          Give Feedback
                        </button>
                      </div>
