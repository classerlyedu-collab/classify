...
const MyChildren = () => {
    ...
    return (
        <div className="flex flex-row w-screen h-screen max-w-[2000px] justify-center items-center mx-auto bg-gradient-to-br from-blue-50 to-indigo-100 flex-wrap">
            {/* Left Sidebar */}
            ...
            {/* Main Content */}
            <div className="lg:w-5/6 w-full h-full overflow-y-auto p-6">
